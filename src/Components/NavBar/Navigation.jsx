  ...
  return (
    <section className="navbarr " ref={navbarRef}>
      ...
      <ul id="navBar" style={{ right: isOpen ? 0 : "-200px" }}>
              ...
              <ul className="dropdown-content">
                ...
                {isBachelorsOpen && (
                  <ul onClick={toggleNav} style={{ listStyle: "none" }}>
                    <li>
                      <NavLink to="/educational-offers/educational-science">
                        Educational Sciences
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/educational-offers/business-administartion">
                        Business Administration
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/educational-offers/civil-engeneering">
                        Civil Engineering
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/educational-offers/sport-science">
                        Sport Sciences
                      </NavLink>
                    </li>
                  </ul>
                ...
                {isMastersOpen && (
                  <ul onClick={toggleNav} style={{ listStyle: "none" }}>
                    <li>
                      <NavLink to="/educational-offers/informatics">
                        Informatics
                      </NavLink>
                    </li>
                    <li>
                      <NavLink to="/educational-offers/sustainable-developement">
        ...
        <li onClick={toggleNav}>
          <NavLink activeclassname="active" aria-current="page" to="/courses">
            <div>Courses</div>
          </NavLink>
        </li>
        <li onClick={toggleNav}>
