    ...
    <>
      <div className="footer_section">
        ...
        <div className="footer">
          ...
          <div className="footer_links_section">
            <div className="footer_links">
              <h1 className="footer_links_name m-0">LINKS</h1>
          ...
          <div>
            <div className="footer_address">
              <div className="footer_locate">
                <h1 className="footer_locateus m-0">LOCATE US</h1>
                <img
                  loading="lazy"
                  decoding="async"
                  alt="Google Location"
              ...
              <h5 rel="noopener noreferrer" className="footer_location">
                40, Villa Fairholme, <br /> Sir Augustus Bartolo Street,{" "}
          ...
          <div className="footer_address">
            <div className="footer_locate">
              <h1 className="footer_locateus m-0">CONTACT US</h1>
              <img
                loading="lazy"
                decoding="async"
                alt="Gmail"
        ...
        <div className="footer_copyrights">
          ...
          >
            The GDPR has been implemented through the Maltese Data Protection
            Act 2018 (Chapter 586 of the Laws of Malta), the “DPA” which
            took effect on 28 May 2018.
          </p>
