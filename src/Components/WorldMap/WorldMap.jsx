          ...
          <ul>
            {countries.map((country, i) => (
              <li
                key={i}
                style={{ color: "#fff" }}
                onMouseOver={() => handleCountryHover(country.id)}
          ...
          >
            ...
            {countries.map((country, i) => (
              <>
                <g
                  key={i}
                  className={highlightedCountry === country.id ? "hover" : ""}
                >
                  {country.id === "tr" && (
                  ...
                  {country.id === "li" && (
                    <path d="m 501.78175,313.6684 -0.218,-0.022 -0.041,0.002 -0.023,-0.145 0.013,-0.309 0.121,-0.404 0.026,0.066 0.015,0.085 0.025,0.09 0.014,0.11 0.045,0.113 0.082,0.107 0.026,0.102 -0.041,0.129 z" />
                  )}
                  {country.id === "lt" && (
                  ...
                  {country.id === "lu" && (
                    <path d="M420.424,397.582l0.76,0.679l0.88,0.083l0.194-1.734l-0.253-0.974l-1.224,0.583L420.424,397.582z" />
                  )}
                  {country.id === "mt" && (
                  ...
                  {country.id === "pt" && (
                    <path d="M430.93,211.24l-0.62,8.65l-1.77,1.6l0.18,0.98l1.24,2.05l-0.8,2.5l1.33,0.45l3.1-0.36l-0.18-2.5l2.03-11.59l-0.44-1.6L430.93,211.24L430.93,211.24z" />
                  )}
                  {country.id === "ro" && (
                  ...
                  {country.id === "sm" && (
                    <path d="m 509.93475,326.2634 -0.165,0.029 -0.083,-0.158 0.124,-0.185 0.176,-0.029 0.031,0.143 z" />
                  )}
                  {country.id === "sk" && (
                  ...
                  {country.id === "es" && (
                    <path d="M448.36,205h-12.74l-2.57-1.16l-1.24,0.09l-1.5,3.12l0.53,3.21l4.87,0.45l0.62,2.05l-2.12,11.95l0.09,2.14l3.45,1.87l3.98,0.27l7.96-1.96l3.89-4.9l0.09-4.99l6.9-6.24l0.35-2.76l-6.28-0.09L448.36,205L448.36,205z" />
                  )}
                  {country.id === "se" && (
                    <>
                  ...
                  {country.id === "va" && (
                    <path d="m 509.80575,333.9114 -0.024,0.003 -0.009,-0.013 0.009,-0.017 0.021,-0.003 z" />
                  )}
                </g>
                <g cc="id">
