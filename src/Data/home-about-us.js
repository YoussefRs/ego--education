...
const aboutusinfo = [
  {
    ...
    ourmission:
      "Finally, thanks to international agreements with our partners e-GO is also able to offer a wide and diversified training opportunity. Our professional team is happy to orienteer you to one of our selected partners’ courses, helping you throughout your educational process, from tutoring and enrollment assistance to technical support and administrative guidance.",
  },
];
